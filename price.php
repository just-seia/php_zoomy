...
<main>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="plan text-center mb-30">
                                ...
                                <div class="pr__body">
                                    <h2 class="mb-30"><span class="old-price d-none">$699</span> <b><sup>$</sup>0<span class="new-price">/ Monthly</span> </b></h2>
                                    <ul class="price-list">
                                        <li>All Courses</li>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="plan plan-2 text-center mb-30">
                                ...
                                <div class="pr__body">
                                    <h2 class="mb-30"><span class="old-price">$10</span> <b><sup>$</sup>5<span class="new-price">/ Monthly</span> </b></h2>
                                    <ul class="price-list">
                                        <li>All Courses</li>
                                        <li>For One Person Uses Only</li>
                                        <li>25+ Article Free</li>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="plan plan-2a text-center mb-30">
                                ...
                                <div class="pr__body">
                                    <h2 class="mb-30"><span class="old-price">$20</span> <b><sup>$</sup>10<span class="new-price">/ Monthly</span> </b></h2>
                                    <ul class="price-list">
                                        <li>All Courses</li>
                                        <li>For One Person Uses Only</li>
                                        <li>25+ Article Free</li>
    ...
    <section class="d-none what-looking-for pos-rel gradient-bg pt-145 pb-130 pt-md-95 pb-xs-80 pt-xs-95 pb-xs-80">
