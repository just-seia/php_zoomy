            ...
            <div class="row">
                <div class="col-xxl-12">
                    <ul class="submenu mega-menu__sub-menu-box course__cat__list">
                        <li><a class="active" href="courses.php">
                                <span>
        ...
        <div class="container">
            ...
            <div class="grid row">
                <div class="col-lg-4 col-md-6 grid-item cat2 cat3">
                    <div class="z-gallery z-gallery-two mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details.php"><img class="img-fluid" src="assets/img/course/07.png" alt=""></a>
                        ...
                        <div class="z-gallery__content pos-rel">
                            <div class="course__tag course__tag__two mb-15">
                                <span>Science</span>
                                <span>Lab</span>
                                <a class="price-tag" href="instructor-details.php">139$</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 grid-item cat1 ">
                    <div class="z-gallery z-gallery-two mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details.php"><img class="img-fluid" src="assets/img/course/08.png" alt=""></a>
                            <div class="feedback-tag">4.8(256)</div>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                        </div>
                        <div class="z-gallery__content pos-rel">
                ...
                <div class="col-lg-4 col-md-6 grid-item cat2">
                    <div class="z-gallery z-gallery-two mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details.php"><img class="img-fluid" src="assets/img/course/09.png" alt=""></a>
                            <div class="feedback-tag">4.8(256)</div>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                        </div>
                        <div class="z-gallery__content pos-rel">
                ...
                <div class="col-lg-4 col-md-6 grid-item cat1">
                    <div class="z-gallery z-gallery-two mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details.php"><img class="img-fluid" src="assets/img/course/10.png" alt=""></a>
                            <div class="feedback-tag">4.8(256)</div>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                        </div>
                        <div class="z-gallery__content pos-rel">
                ...
                <div class="col-lg-4 col-md-6 grid-item cat3">
                    <div class="z-gallery z-gallery-two mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details.php"><img class="img-fluid" src="assets/img/course/11.png" alt=""></a>
                            <div class="feedback-tag">4.8(256)</div>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                        </div>
                        <div class="z-gallery__content pos-rel">
                            <div class="course__tag course__tag__two mb-15">
                                <span>Science</span>
                                <span>Lab</span>
                                <a class="price-tag" href="instructor-details.php">238$</a>
                            </div>
                            <h4 class="sub-title mb-20"><a href="course-details.php">Take Your Career to the Next Level Future</a></h4>
                            <div class="course__meta d-flex align-items-center justify-content-between mb-15">
                                <span><img class="icon" src="assets/img/icon/time.svg" alt="course-meta"> 12 Periods</span>
                ...
                <div class="col-lg-4 col-md-6 grid-item cat2 cat3">
                    <div class="z-gallery z-gallery-two mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details.php"><img class="img-fluid" src="assets/img/course/12.png" alt=""></a>
                            <div class="feedback-tag">4.8(256)</div>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                        </div>
                        <div class="z-gallery__content pos-rel">
                            <div class="course__tag course__tag__two mb-15">
                                <span>Science</span>
                                <span>Lab</span>
                                <a class="price-tag" href="instructor-details.php">300$</a>
                            </div>
                            <h4 class="sub-title mb-20"><a href="course-details.php">Your Career to build for the pro level</a></h4>
                            <div class="course__meta d-flex align-items-center justify-content-between mb-15">
                                <span><img class="icon" src="assets/img/icon/time.svg" alt="course-meta"> 12 Periods</span>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="faq-btn pl-75 mt-50">
                        <a href="faq.php" class="theme_btn">Ask Question</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="z-blogs mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                            <div class="z-blogs__thumb mb-25">
                                <a href="blog-details.php"><img src="assets/img/blog/04.png" alt="blog-img"></a>
                            </div>
                            <div class="z-blogs__content z-blogs__content-02">
                                ...
                                <a href="blog-details.php" class="blog_btn">Read More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="z-blogs mb-30 wow fadeInUp2 animated" data-wow-delay='.2s'>
                            <div class="z-blogs__thumb mb-25">
                                <a href="blog-details.php"><img src="assets/img/blog/05.png" alt="blog-img"></a>
                            </div>
                            <div class="z-blogs__content z-blogs__content-02">
                                <div class="z-blogs__meta d-flex justify-content-between mb-10">
                                    <span><img class="mr-5" src="assets/img/icon/date-line.svg" alt=""> 03/06/2021</span>
                                ...
                                <h4 class="sub-title mb-15"><a href="blog-details.php">Tecnology means inculcating high values</a></h4>
                                <p class="mb-20">Lorem ipsum dolor sit amet, consetetur saps cing elitr, sed di nonumy eirmod temporinvid unt ut labore et dolore.</p>
                                <a href="blog-details.php" class="blog_btn">Read More</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="z-blogs mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                            <div class="z-blogs__thumb mb-25">
                                <a href="blog-details.php"><img src="assets/img/blog/06.png" alt="blog-img"></a>
                            </div>
                            <div class="z-blogs__content z-blogs__content-02">
                                <div class="z-blogs__meta d-flex justify-content-between mb-10">
                                    <span><img class="mr-5" src="assets/img/icon/date-line.svg" alt=""> 03/06/2021</span>
                                ...
                                <h4 class="sub-title mb-15"><a href="blog-details.php">Courses means inculcating moral values</a></h4>
                                <p class="mb-20">Lorem ipsum dolor sit amet, consetetur saps cing elitr, sed di nonumy eirmod temporinvid unt ut labore et dolore.</p>
                                <a href="blog-details.php" class="blog_btn">Read More</a>
                            </div>
                        </div>
