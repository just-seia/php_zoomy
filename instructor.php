            ...
            <div class="row">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="z-instructors text-center mb-30">
                        ...
                        <div class="z-instructors__content">
                            <h4 class="sub-title mb-10"><a href="instructor-profile.php">Lebron Jain</a></h4>
                            <p>IT Specialist</p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="z-instructors text-center mb-30">
                        ...
                        <div class="z-instructors__content">
                            <h4 class="sub-title mb-10"><a href="instructor-profile.php">Ariana Cany</a></h4>
                            <p>UArt Specialist</p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="z-instructors text-center mb-30">
                        ...
                        <div class="z-instructors__content">
                            <h4 class="sub-title mb-10"><a href="instructor-profile.php">George Emily</a></h4>
                            <p>HR Manager</p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="z-instructors text-center mb-30">
                        ...
                        <div class="z-instructors__content">
                            <h4 class="sub-title mb-10"><a href="instructor-profile.php">Chris Jordan</a></h4>
